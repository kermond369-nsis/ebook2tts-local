...
> 当前条目：**BUG-P7-001 ~ 014** ｜ 分级：**P1 ×3**（001 错误码 / 004 16 KB 对齐 / 011 冷启首请求被拒）、**P2 ×5**（002 备份密钥 / 003 通知权限 / 008 历史崩溃 / 013 中止不唤醒等待 / 014 试听后整模型重载）、**P3 ×6**（005 / 006 / 007 / 009 / 010 / 012）
> 真机：**Mi MIX 2S（SDM845 / Android 14）** 已接入并完成首轮实测（详见《P7-真机报告》）；004 **已修复提交**（私密仓 `b6d0e5e`），011/014 修复方案据真机数据**调整**
